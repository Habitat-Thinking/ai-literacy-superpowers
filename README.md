...
[![ai-literacy-superpowers](https://img.shields.io/badge/ai--literacy--superpowers-v0.64.2-4682B4?style=flat-square)](ai-literacy-superpowers/)
...
| ------ | ------- | ------------ | ---- |
| **`ai-literacy-superpowers`** | v0.64.2 | The flagship. Harness engineering, agent orchestration, literate programming, CUPID code review, compound learning, and the three enforcement loops. **36 skills, 16 agents, 28 commands.** | [docs](docs/plugins/ai-literacy-superpowers/index.md) |
